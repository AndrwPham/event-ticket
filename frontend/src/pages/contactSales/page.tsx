    ...
    const contactOptions = [
        {
            ...
            title: "Find Tickets",
            description:
                "Looking for events? Browse all our upcoming events or use the search to find exactly what you're looking for.",
            linkTo: "/events",
        ...
        },
        {
            ...
            description:
                "Are you an organizer? List your event on our platform and reach a wider audience effortlessly.",
            linkTo: "/create-event",
        ...
        },
        {
            ...
            title: "My Account",
            description:
                "Manage your profile, view your purchased tickets, and update your personal information.",
            linkTo: "/profile",
